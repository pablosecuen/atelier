  ...
  return (
    <div className="flex flex-col w-1/3 mx-auto min-h-screen pt-12 md:pt-24 text-black ">
      ...
      <p className="text-start text-lg pb-8">
        ...
        posible que te pidamos tu nombre, dirección de correo electrónico, dirección postal, número
        de teléfono, medidas corporales, detalles de pago, comportamiento de compra y navegación,
        uso del sitio web u otra información. La información de la tarjeta de crédito se solicitará
        para la compra y se procesará a través de un proveedor de pagos. La información se
        almacenará cifrada con nosotros como prueba del pago. Estos datos son obligatorios para
        procesar el pedido. Puedes visitar nuestro sitio de forma anónima. También recopilamos
        información sobre los destinatarios de regalos para poder cumplir con la compra del regalo.
        Al igual que muchos sitios web, utilizamos "cookies" para mejorar tu experiencia y recopilar
        información sobre los visitantes y las visitas a nuestros sitios web. Consulta la sección
      ...
      <p className="text-start text-lg pb-8">
        ...
        información sobre el uso de tu información (para ello, ponte en contacto con nuestro Oficial
        de Protección de Datos o el Servicio de Atención al Cliente). Los datos relativos a la
        transacción se almacenarán con nosotros durante al menos 5 años después del final del año
        financiero en el que se realizó el pedido, según la Ley de Contabilidad nacional. La
      ...
      <p className="text-start text-lg pb-8">
        ...
        siguientes maneras: personalizar tu experiencia en el sitio y permitirnos ofrecer el tipo de
        contenido y ofertas de productos que más te interesen. Para permitirnos brindarte un mejor
        servicio al responder a tus solicitudes de servicio al cliente. Para procesar rápidamente
        tus transacciones. Para informarte sobre noticias interesantes de la empresa y enviarte
        promociones personalizadas con fines publicitarios. Para comprender mejor el uso de nuestro
        sitio web y realizar análisis. Para administrar un concurso, promoción, encuesta u otra
        función del sitio. Si has optado por recibir nuestro boletín por correo electrónico, es
        posible que te enviemos correos electrónicos periódicos. Si ya no deseas recibir correos
        electrónicos promocionales de nuestra parte, consulta la sección "¿Cómo funciona la
        suscripción por correo electrónico? ¿Cómo puedo suscribirme o cancelarla?" a continuación.
        Los visitantes que se registran o participan en otras funciones del sitio, como programas de
      ...
      <p className="text-start text-lg pb-8">
        ...
        dichos sistemas y están obligadas a mantener la información confidencial. Cuando realizas
        pedidos o accedes a tu información personal, ofrecemos el uso de un servidor seguro. La
        información se guardará durante un período ilimitado de tiempo, a menos que nos pidas que
        eliminemos tu información personal. Toda la información de tarjetas de crédito y de pago que
        proporciones se transmitirá mediante tecnología de capa de conexión segura (SSL) y luego se
      ...
      <p className="text-start text-lg pb-8">
        ...
        y capturar y recordar cierta información, también para redes sociales. Por ejemplo,
        utilizamos cookies para ayudarnos a recordar y procesar los artículos en tu carrito de
        compras. También se utilizan para ayudarnos a comprender tus preferencias según la actividad
        anterior o actual en el sitio, lo que nos permite ofrecerte mejores servicios. También
        utilizamos cookies para ayudarnos a recopilar datos agregados sobre el tráfico del sitio y
        la interacción en el sitio para que podamos ofrecer mejores experiencias y herramientas en
        el futuro. Es posible que contratemos a proveedores de servicios de terceros para ayudarnos
        a comprender mejor a nuestros visitantes. A estos proveedores de servicios no se les permite
        utilizar la información recopilada en nuestro nombre, excepto para ayudarnos a llevar a cabo
        y mejorar nuestro negocio. Estos sitios enlazados tienen políticas de privacidad separadas e
        independientes. Por lo tanto, no tenemos ninguna responsabilidad ni responsabilidad por el
        contenido y las actividades de estos sitios enlazados. No obstante, buscamos proteger la
        integridad de nuestro sitio y agradecemos cualquier comentario sobre estos sitios enlazados
        (incluido si un enlace específico no funciona). Puedes gestionar esto a través de la
        configuración de tu navegador (como Safari o Internet Explorer). Cada navegador es un poco
        diferente, así que consulta el menú "Ayuda" de tu navegador para aprender la forma correcta
      ...
      <p className="text-start text-lg pb-8">
        ...
        alojamiento de sitios web y otras partes que nos ayudan a operar nuestro sitio web, llevar a
        cabo nuestro negocio o atenderte, siempre que esas partes acuerden mantener esta información
        confidencial. También podemos divulgar tu información cuando creemos que su divulgación es
        apropiada para cumplir con la ley, hacer cumplir nuestras políticas del sitio o proteger
        nuestros derechos, propiedad o seguridad o la de otros. No obstante, la información no
      ...
      <p className="text-start text-lg pb-8">
        ...
        enviar el boletín a esta dirección, utilizamos el procedimiento de doble opt-in. En el
        transcurso de este procedimiento, el posible destinatario puede ser incluido en una lista de
        distribución. Luego, el usuario recibe un correo electrónico de confirmación para confirmar
        la solicitud legalmente. Solo cuando se realiza la confirmación, la dirección se incluye
        activamente en el distribuidor. Utilizamos estos datos exclusivamente para la entrega de la
        información y ofertas solicitadas, principalmente con fines informativos y publicitarios.
        Como proveedor de software de boletines, trabajamos con un programa de terceros. Tus datos
        se transmitirán a esta parte, a la que se le prohíbe vender y utilizar tus datos para fines
        distintos al envío de nuestros boletines. El consentimiento otorgado para el almacenamiento
        de datos, la dirección de correo electrónico y su uso para el envío del boletín, se puede
        revocar en cualquier momento a través del enlace "darse de baja" en el boletín. Ten en
      ...
      <p className="text-start text-lg pb-8">
        ...
        política se aplicarán solo a la información recopilada después de la fecha del cambio. Esta
        política se modificó por última vez el 25 de mayo de 2018. Estos términos y condiciones
