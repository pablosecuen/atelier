...
export function GridTileImage({
  ...
  return (
    <div
      className={clsx(
        "group flex w-full h-full min-h-full items-center justify-center overflow-hidden rounded-lg border-2  hover:border-blue-600 ",
        {
          relative: label,
          "border-3 border-blue-600": active,
