...
function CategoriesBanner() {
  const commonClass =
    "bg-dessshirtbg bg-cover bg-center bg-no-repeat h-[450px] w-[350px] flex justify-start items-end p-2";
  ...
  return (
    <>
      <div className="w-full flex flex-wrap scroll-auto h-96 text-2xl p-10 gap-10 justify-center my-32">
        <div className={commonClass}>Dress Shirt</div>
        <div className={commonClass}>Casual Shirt</div>
        <div className={commonClass}>Athelier</div>
        <div className={commonClass}>Accesories</div>
      </div>
