...
export default async function Footer() {
  ...
  return (
    <footer className="text-sm text-white  bg-[#242528] z-50">
      ...
      <div className="h-32 border-t-2 pt-1 border-white/40 text-xs  md:text-md font-semibold flex justify-between  items-center max-w-7xl mx-auto px-12 md:px-0">
        <span>NECESITAS AYUDA?</span>
        <div className="md:py-4 py-2  px-4 md:px-16 border-2 border-terciario font-bold rounded-full flex flex-col gap-1">
          ...
          <span>lunes-domings 9-21 (CET)</span>
          <span className="underline">Llámanos: (+34)900814584</span>
        </div>
      </div>
