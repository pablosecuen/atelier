  ...
  return (
    <>
      <button
        ...
        className="flex h-11 w-11 text-secundario items-center justify-center rounded-md  border-neutral-200  transition-colors dark:border-neutral-700 dark:text-black md:hidden"
      >
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeMobileMenu} className="relative z-50">
          ...
          >
            <Dialog.Panel className="fixed backdrop-blur-xl bottom-0 left-0 right-0 top-12 md:top-16 flex h-full w-full md:w-[350px] flex-col justify-between bg-white pb-6 dark:bg-primario/50 bg-primario/50">
              <div className="p-4">
                <button
